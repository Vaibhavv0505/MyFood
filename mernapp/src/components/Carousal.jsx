        ...
        <div>
            <div id="carouselExampleFade" className="carousel slide carousel-fade" data-bs-ride="carousel" style={{ objectFit: "contain !important" }}>
                <div className="carousel-inner" id='carousel'>
                    <div className="crausal-caption" style={{ zIndex: "10" }}><form className="d-flex" style={{ margin: "5px" }}>
                    ...
                    <div className="carousel-item">
                        <img src="https://source.unsplash.com/random/900x700/?noodle" className="d-block w-100" alt='..' style={{ filter: "brightness(30%)" }} />
                    </div>
                </div>
